...
import 'package:must_invest_service_man/core/observers/bloc_observer.dart';
...
Future<void> main() async {
  ...
  // Get the language code from MustInvestServiceManPreferences
  // final codeLang = sl<MustInvestServiceManPreferences>().getLang();
  runApp(
    EasyLocalization(
