...
class PrivacyPolicyScreen extends StatefulWidget {
  ...
  const PrivacyPolicyScreen({super.key, this.language});
...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Load privacy policy with language parameter
    PagesCubit.get(context).getPrivacyPolicy(lang: widget.language);
  }
            ...
            child: BlocBuilder<PagesCubit, PagesState>(
              builder: (context, state) {
                if (state is PagesLoading) {
                  ...
                  final htmlContent = state.data as PrivacyPolicyModel;
                  _fadeController.forward();
                  return _buildPrivacyContent(htmlContent.content);
                } else {
          ...
          child: SafeArea(
            child: Column(
              ...
              children: [
                ...
                Text(
                  LocaleKeys.our_privacy_policy.tr(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            LocaleKeys.loading_privacy_policy.tr(),
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.grey[600]),
          ),
          const SizedBox(height: 8),
          Text(
            LocaleKeys.please_wait_loading_privacy_policy.tr(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          Text(
            LocaleKeys.failed_to_load_privacy_policy.tr(),
          ...
          ElevatedButton.icon(
            onPressed: () => PagesCubit.get(context).getPrivacyPolicy(lang: widget.language),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.privacy_tip_outlined, size: 64, color: Colors.grey[400]),
          ),
          const SizedBox(height: 24),
          Text(
            LocaleKeys.no_privacy_policy_available.tr(),
            style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black87),
          ),
          const SizedBox(height: 12),
          Text(
            LocaleKeys.no_privacy_policy_available_description.tr(),
            style: TextStyle(fontSize: 16, color: Colors.grey[600], height: 1.5),
            textAlign: TextAlign.center,
          ),
        ],
  ...
  Widget _buildPrivacyContent(String htmlContent) {
  ...
  void _sharePrivacyPolicy() {
    // Share.share(
    //   'Check out our Privacy Policy', // You can customize this message
    //   subject: LocaleKeys.privacy_policy.tr(),
    // );
  }
