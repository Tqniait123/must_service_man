...
class AppStyles {
  ...
  static TextStyle bold40black = TextStyle(
    color: AppColors.black,
    fontSize: 40.r,
    fontWeight: FontWeight.bold,
  );
  static TextStyle bold24Grey = TextStyle(
    color: Colors.grey,
    fontSize: 24.r,
    fontWeight: FontWeight.w700,
  );
  static TextStyle regular15greyC8 = TextStyle(
    color: AppColors.grey4A,
    fontSize: 15.r,
    fontWeight: FontWeight.w400,
  );
  static TextStyle regular15black26 = TextStyle(
  ...
  static TextStyle regular14blue = TextStyle(
