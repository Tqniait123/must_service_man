...
import 'package:must_invest_service_man/core/extensions/context_extensions.dart';
import 'package:must_invest_service_man/core/extensions/dimensions_manager.dart';
import 'package:must_invest_service_man/core/extensions/num_extension.dart';
import 'package:must_invest_service_man/core/extensions/page_transition.dart';
import 'package:must_invest_service_man/core/extensions/string_extensions.dart';
import 'package:must_invest_service_man/core/extensions/text_style_extension.dart';
import 'package:must_invest_service_man/core/extensions/theme_extension.dart';
import 'package:must_invest_service_man/core/utils/widgets/scaffold/blurred_circle.dart';
import 'package:shimmer/shimmer.dart';

Duration transitionDuration = const Duration(milliseconds: 300);

extension WidgetExtension on Widget {
  Widget withBlurredCircle() =>
      Stack(children: [const BlurredBackgroundCircle(), this]);
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  title,
                  style: titleStyle ?? context.bodyLarge.bold.s12,
  ...
  Widget setCircleBorder(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
          color: color ?? context.inputFieldBorderColor,
          width: width ?? 1,
        ),
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, value, child) {
        return InkWell(
          ...
          highlightColor:
              value ? highlightColor.withOpacity(0.5) : highlightColor,
          borderRadius: borderRadius,
          ...
          child: AnimatedDefaultTextStyle(
            ...
            style:
                style?.copyWith(
                  color: value ? style.color?.withOpacity(0.5) : style.color,
                ) ??
